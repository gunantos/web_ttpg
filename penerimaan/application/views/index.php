...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="http://terminalpulogebang.com/#home">Home</a></li>
          <li><a href="http://terminalpulogebang.com/#about">Tentang Terminal</a></li>
          <li><a href="http://terminalpulogebang.com/#why-us">Bus Akap</a></li>
          <li><a href="http://terminalpulogebang.com/#portfolio">Galery Terminal</a></li>
          <li><a href="http://terminalpulogebang.com/#team">Angkutan Perkotaan</a></li>
          <li><a href="http://terminalpulogebang.com/#contact">Contact</a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="home" style="margin-top: 80px">
  <img src="assets/img/slide/keberangkatan.jpg" class="img-fluid" style="width: 100%;
    height: 280px;padding: 0px 80px 20px 80px; filter: grayscale(30%);"/>
        <div class="section-title">
          <b>Open Rekrutmen PJLP </b><br>
          <b>(Teknisi - Listrik)</b>
          <p style="padding-top: 20px">Bagi anda yang berminat silahkan daftar dengan mengunjungi link dibawah ini:<br>
          <a href="https://s.id/-N2kt" target="_blank">https://s.id/-N2kt</a>
        </p>
        </div>
        </div>
      </div>
