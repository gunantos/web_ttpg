...
<section class="content">
  <div class="box">
        <div class="box-header with-border">
          <div align="left"><h4><b>Informasi Kedatangan  Penumpang di Terminal Terpadu Pulo Gebang </b></h4></div>
   ...
   <div class="panel panel-primary">
    <div class="panel-heading">
        <h9 class="panel-title"><i class="icon-book"></i> Data Kedatangan Penumpang (Harian)</h9>
    <div class="col-sm-4 pull-right">
		...
		<div id="chart-harian" style="width:100%; height:400px;"></div>
            ...
            <div class="panel panel-primary">
        <div class="panel-heading">
          <h9 class="panel-title"><i class="icon-book"></i>Data Kedatangan Penumpang AKAP (Bulanan)</h9>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
        var myChart = Highcharts.chart('chart-harian', {
            ...
            title: {
                text: 'Grafik Kedatangan Penumpang'
            },
            xAxis: {
                categories: arrTgl
            },
        ...
        var myChart = Highcharts.chart('chart-bulan', {
            ...
            series: [{
                name: 'Kedatangan Penumpang Bus AKAP',
