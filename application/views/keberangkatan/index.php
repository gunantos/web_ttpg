...
<section class="content">
  <div class="box">
        <div class="box-header with-border">
          <div align="left"><h4><b>Informasi Keberangkatan  Bus di Terminal Terpadu Pulo Gebang </b></h4></div>
   ...
   <div class="panel panel-primary">
    <div class="panel-heading">
        <h9 class="panel-title"><i class="icon-book"></i> Data Keberangkatan Bus (Harian)</h9>
    <div class="col-sm-4 pull-right">
		...
		<div id="chart-harian" style="width:100%; height:400px;"></div>
            ...
            <div class="panel panel-primary">
        <div class="panel-heading">
          <h9 class="panel-title"><i class="icon-book"></i>Data Keberangkatan Bus AKAP (Bulanan)</h9>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
        var myChart = Highcharts.chart('chart-harian', {
            ...
            title: {
                text: 'Grafik Keberangkatan Bus AKAP'
            },
            xAxis: {
                categories: arrTgl
            },
