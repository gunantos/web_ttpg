  ...
  <div class="col-md-3">
    ...
    <div class="box box-primary">
      <div class="box-body box-profile">
        ...
        <p class="text-muted text-center">Terminal Terpadu Pulo Gebang</p>
        ...
        <div class="active tab-pane" id="settings">
          <form class="form-horizontal" action="<?php echo base_url('Profile/update') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Name" name="nama_user" value="<?php echo $userdata->nama_user; ?>">
              </div>
            </div>
            <div class="form-group">
